...
const createHTML = (data) => data.forEach(business => {
    outEl.innerHTML += `
...
//createHTML(newYorkBusinesses)


const manufactortingBusinesses = businesses.filter(business => {
    let manuBusi = false
...
//createHTML(manufactortingBusinesses)
